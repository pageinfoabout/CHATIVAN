...
const Community = () => {
  ...
  return (
    <div className='p-6 pt-12 xl:px-12 2xl:px-20 w-full mx-auto h-full overflow-y-scroll'>
      <h2 className='text-2xl font-semibold mb-6 text-gray-800 dark:text-purple-100'>Community Images</h2>
      {images.length > 0 ? (
          ...
          {images.map((image, index) => (
            ...
            >
              <img
                src={image.imageUrl}
                alt=""
                className='w-full h-40 md:h-60 2xl:h-72 object-cover group-hover:scale-105 transition-transform duration-300 ease-in-out'
              />
